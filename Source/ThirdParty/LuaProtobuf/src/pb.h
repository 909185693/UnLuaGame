...
LUAPROTOBUF_API int luaopen_pb(struct lua_State *L);
LUAPROTOBUF_API int luaopen_pb_slice(struct lua_State *L);
LUAPROTOBUF_API int luaopen_pb_buffer(struct lua_State *L);
LUAPROTOBUF_API int luaopen_pb_conv(struct lua_State *L);
